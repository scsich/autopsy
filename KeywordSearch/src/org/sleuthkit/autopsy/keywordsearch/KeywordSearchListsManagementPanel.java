...
class KeywordSearchListsManagementPanel extends javax.swing.JPanel implements OptionsPanel {
    ...
    private void newListButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newListButtonActionPerformed
        ...
        String listName = (String) JOptionPane.showInputDialog(null,
                ...
                NbBundle.getMessage(this.getClass(), "KeywordSearch.newKeywordListMsg"), JOptionPane.PLAIN_MESSAGE,
                null, null, "");
        ...
        if (writer.listExists(listName)) {
            if (writer.getList(listName).isLocked()) {
                boolean replace = KeywordSearchUtil.displayConfirmDialog(
                        ...
                        NbBundle.getMessage(this.getClass(), "KeywordSearch.keywordListAlreadyExistMsg", listName),
                ...
                boolean replace = KeywordSearchUtil.displayConfirmDialog(
                        NbBundle.getMessage(this.getClass(), "KeywordSearch.newKwListTitle"),
                        NbBundle.getMessage(this.getClass(), "KeywordSearch.kwListAlreadyExistMsg", listName),
                        KeywordSearchUtil.DIALOG_MESSAGE_TYPE.WARN);
                if (replace) {
                    shouldAdd = true;
                }
