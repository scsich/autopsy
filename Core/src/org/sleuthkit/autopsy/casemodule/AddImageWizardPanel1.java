...
class AddImageWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor>, PropertyChangeListener {
    ...
    public void readSettings(WizardDescriptor settings) {
        ...
        ModuleSettings moduleSettings = new ModuleSettings(ModuleSettings.MAIN_SETTINGS);

        // Prepopulate the image directory from the properties file
        try {
            String lastDataSourceDirectory = moduleSettings.getConfigSetting(PROP_LASTDATASOURCE_PATH);
            String lastDataSourceType = moduleSettings.getConfigSetting(PROP_LASTDATASOURCE_TYPE);
    ...
    public void storeSettings(WizardDescriptor settings) {
        ...
        moduleSettings.setConfigSetting(PROP_LASTDATASOURCE_PATH, firstImagePath);
        moduleSettings.setConfigSetting(PROP_LASTDATASOURCE_TYPE, getComponent().getContentType().toString());
    }
